...
class HomeBannerAdapter: ListAdapter<Banner, HomeBannerAdapter.HomeBannerViewHolder>(BannerDiffCallback()) {
    ...
    class HomeBannerViewHolder(view: View): RecyclerView.ViewHolder(view){
        private val bannerImageView = view.findViewById<ImageView>(R.id.cd_banner_image)
        ...
        private val bannerDetailThumbnailImageView = view.findViewById<ImageView>(R.id.cd_banner_detail_thumbnail)
